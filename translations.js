...
(function () {
    const TRANSLATIONS = {
        en: {
            ...
            care_modal_title: "Customer Support",
            care_modal_msg: "If you are facing any issue or need assistance, you can speak directly with our customer support.",
            call_now: "Call Now",
            cancel: "Cancel",
            ...
            cashback_scratch_unlocked: "₹{amount} Cashback (Scratch Card unlocked!)",
            cashback_teaser_sub: "Scratch card will be credited directly to your wallet upon delivery",
            ...
            info_legal_policies: "Info & Legal Policies",
            info_legal_policies_sub: "Terms, Privacy Policy & Cancellation rules",
            store_notice: "Store Notice",
            store_notice_sub: "Important updates & announcements",
            store_policy_notice: "Store Policy & Notice",
            store_policy_notice_sub: "Store guidelines, terms reference & updates",
            ...
            clear_order_history: "Clear Order History",
            ...
            scratch_instruction: "Scratch the card using your finger or mouse! (40% required)",
            ...
            scratch_claim_btn: "कन्फर्म करें और वॉलेट में जोड़ें / Claim to Wallet",
            scratch_claiming: "Claiming to Wallet...",
            scratch_claimed_btn: "Credited to Wallet ✓",
            scratch_already_claimed: "Already Claimed",
            scratch_unclaimed_alert: "🎉 Mystery Reward Unlocked! Scratch the card to reveal your cashback reward",
            scratch_locked_hint: "🎉 Mystery Reward Unlocked (Tap to Scratch)",
            scratch_claimed_badge: "Claimed (+₹{amount} in wallet)",
            scratch_card_unlocked_otp: "🎉 Mystery Reward Unlocked!",
            scratch_card_otp_sub: "Scratch the card to reveal your cashback reward",
            scratch_unclaimed_card_title: "🎉 Mystery Reward Unlocked!",
        ...
        hi: {
            ...
            care_modal_title: "कस्टमर सपोर्ट",
            care_modal_msg: "अगर आपको कोई भी समस्या है या किसी भी प्रकार की सहायता चाहिए, तो आप सीधे हमारे कस्टमर केयर से बात कर सकते हैं।",
            call_now: "कॉल करें",
            cancel: "रद्द करें",
            ...
            cashback_scratch_unlocked: "₹{amount} कैशबैक (स्क्रैच कार्ड अनलॉक!)",
            cashback_teaser_sub: "ऑर्डर डिलीवर होते ही आपके वॉलेट में स्क्रैच कार्ड क्रेडिट हो जाएगा",
            wallet_paused: "कैशबैक रिवॉर्ड सिस्टम फ़िलहाल बंद है।",
            wallet_system_paused: "सिस्टम बंद है",
            wallet_legacy_balance_notice: "मौजूदा वॉलेट बैलेंस का उपयोग कर रहे हैं। नए कैशबैक रिवॉर्ड अभी रुके हुए हैं।",
            wallet_system_paused_modal_toast: "वॉलेट कैशबैक रिवॉर्ड अभी रोक दिए गए हैं।",
            wallet_transactions: "वॉलेट लेन-देन",
            wallet_no_transactions: "अभी कोई लेन-देन नहीं है। कैशबैक पाने के लिए ऑर्डर करें!",
            ...
            customer_name_fallback: "ग्राहक का नाम",
            edit_profile_address: "प्रोफ़ाइल और घर का पता एडिट करें",
            edit_profile_sub: "अपना नाम, मोबाइल नंबर और सेव पते बदलें",
            info_legal_policies: "जानकारी और नियम नीतियां",
            info_legal_policies_sub: "नियम, गोपनीयता नीति और रद्दीकरण नियम",
            store_notice: "स्टोर सूचना",
            store_notice_sub: "ज़रूरी सूचनाएँ और घोषणाएँ",
            store_policy_notice: "दुकान नीति व सूचना",
            store_policy_notice_sub: "दुकान दिशानिर्देश, शर्तें और अपडेट",
            recent_orders: "हाल के ऑर्डर",
            no_orders_placed: "अभी तक कोई ऑर्डर नहीं किया गया है",
            no_recent_active_orders: "कोई हालिया सक्रिय ऑर्डर नहीं",
            clear_history: "पूरे हुए ऑर्डर हटाएं",
            clear_completed_orders: "पूरे हुए ऑर्डर हटाएं",
            clear_order_history: "ऑर्डर इतिहास साफ़ करें",
            ...
            // Scratch Card Rewards
            scratch_card_title: "🎉 मिस्ट्री रिवॉर्ड अनलॉक हुआ!",
            scratch_card_subtitle: "कैशबैक रिवॉर्ड देखने के लिए कार्ड स्क्रैच करें",
            scratch_won_banner: "आपने जीता ₹{amount} कैशबैक!",
            scratch_claimed_status: "क्लेम किया गया (+₹{amount} वॉलेट में)",
            scratch_instruction: "कार्ड को उंगली या माउस से स्क्रैच करें! (कम से कम 40%)",
            ...
            scratch_claim_btn: "कन्फर्म करें और वॉलेट में जोड़ें / Claim to Wallet",
            scratch_claiming: "वॉलेट में जोड़ा जा रहा है...",
            scratch_claimed_btn: "वॉलेट में जुड़ गया ✓",
            scratch_already_claimed: "पहले ही क्लेम हो चुका है",
            scratch_unclaimed_alert: "🎉 मिस्ट्री रिवॉर्ड अनलॉक हुआ! रिवॉर्ड देखने के लिए स्क्रैच करें!",
            scratch_locked_hint: "🎉 मिस्ट्री रिवॉर्ड अनलॉक (स्क्रैच करने के लिए टैप करें)",
            scratch_claimed_badge: "क्लेम किया गया (+₹{amount} वॉलेट में)",
            scratch_card_unlocked_otp: "🎉 मिस्ट्री रिवॉर्ड अनलॉक हुआ!",
            scratch_card_otp_sub: "कैशबैक रिवॉर्ड देखने के लिए कार्ड स्क्रैच करें",
            scratch_unclaimed_card_title: "🎉 मिस्ट्री रिवॉर्ड अनलॉक हुआ!",
