...
(function () {
    const TRANSLATIONS = {
        en: {
            ...
            cashback_scratch_unlocked: "Win up to ₹{max} Cashback (Scratch Card unlocked!)",
            ...
            scratch_card_title: "Cashback Scratch Card 🎁",
            scratch_card_subtitle: "Order #{id} • Scratch to reveal your reward!",
            scratch_instruction: "Scratch the card using your finger or mouse!",
            scratch_you_won: "YOU WON!",
            scratch_cashback_bonus: "Cashback Reward",
            scratch_validity_note: "Valid for {days} days in your wallet",
            scratch_claim_btn: "Claim to Wallet",
            scratch_claiming: "Claiming Reward...",
            scratch_claimed_btn: "Claimed to Wallet ✓",
            scratch_already_claimed: "Already Claimed",
            scratch_unclaimed_alert: "🎁 You have an Unclaimed Scratch Card waiting!",
            scratch_locked_hint: "🎁 Scratch Card Locked (Unlocks upon delivery)",
            ...
            scratch_card_otp_sub: "Scratch & claim your reward in Order History once delivered!",
        ...
        hi: {
            ...
            cashback_scratch_unlocked: "₹{max} तक का कैशबैक जीतें (स्क्रैच कार्ड अनलॉक!)",
            ...
            // Scratch Card Rewards
            scratch_card_title: "कैशबैक स्क्रैच कार्ड 🎁",
            scratch_card_subtitle: "ऑर्डर #{id} • अपना इनाम देखने के लिए स्क्रैच करें!",
            scratch_instruction: "कार्ड को उंगली या माउस से स्क्रैच करें!",
            ...
            scratch_claim_btn: "वॉलेट में क्लेम करें",
            scratch_claiming: "क्लेम किया जा रहा है...",
            scratch_claimed_btn: "वॉलेट में क्लेम हो गया ✓",
            scratch_already_claimed: "पहले ही क्लेम हो चुका है",
            scratch_unclaimed_alert: "🎁 आपके पास एक अनक्लेम्ड स्क्रैच कार्ड है!",
            scratch_locked_hint: "🎁 स्क्रैच कार्ड लॉक है (डिलीवरी पर खुलेगा)",
            ...
            scratch_card_otp_sub: "ऑर्डर डिलीवर होते ही ऑर्डर हिस्ट्री में स्क्रैच और क्लेम करें!",
